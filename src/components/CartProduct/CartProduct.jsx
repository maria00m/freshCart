...
export default function CartProduct({ product, setCart }) {
  ...
  const handleBlur = () => {
    // Call the update function to update the product count on the server
      ...
      <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
        ...
        <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
          <div className="flex items-center border-gray-100">
            ...
            >
              {isDecreaseLoading ? <i className="fas fa-spinner spin"></i> : '-'}
            </button>
            <input
              onBlur={handleBlur}
            ...
            >
              {isIncreaseLoading ? <i className="fas fa-spinner spin"></i> : '+'}
            </button>
          </div>
